...
@Alias("CARBONADO_B2")
public interface StoredB2 extends Storable {
    int getID();
    void setID(int id);
    ...
    StoredB1 getParent() throws FetchException;
    void setParent(StoredB1 parent);

    @Join(internal="ID", external="parentID")
    Query<StoredB3> getChildren() throws FetchException;
}
